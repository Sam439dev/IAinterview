...
# now_utc is imported from utils, but keep alias for backward compatibility
# (Note: now_utc is already imported from utils)
...
# Note: DATE_PATTERNS, MONTH_MAP, parse_date_string, sort_experiences_chronologically,
# calculate_experience_freshness, get_missing_date_experiences are now imported from
# services.chronology_service via the services package.
...
# Note: detect_request, calculate_confidence, estimate_speaker and CONFIDENCE_THRESHOLD
# are now imported from services.detection_service via the services package.
